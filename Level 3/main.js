...
let fibSeries = []; // Array untuk menyimpan deret Fibonacci

for (let i = 0; i <= numberForFibonacci; i++) {
  fibSeries.push(fibonacci(i)); // Tambahkan elemen Fibonacci baru ke array
  console.log(` ${fibSeries.join(', ')} `); // Tampilkan array dalam format yang diinginkan
}
