...
// Menggunakan JSON.stringify untuk mencetak output dalam format yang lebih jelas
...
// Menggunakan JSON.stringify untuk mencetak output setelah update status
console.log(JSON.stringify(orders, null, 2));
/**
 * Output yang diharapkan:
 * [
...
// Menggunakan JSON.stringify untuk mencetak output setelah delete order
console.log(JSON.stringify(orders, null, 2));
/**
 * Output yang diharapkan:
 * [
